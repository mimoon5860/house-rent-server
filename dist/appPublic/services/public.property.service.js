...
class PublicPropertyServices extends abstract_service_1.default {
    constructor() {
        super();
    }
    // get property
    getProperty(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const filter = Object.assign({ isDeleted: false, status: "Active" }, rest);
            if (limit) {
...
exports.default = PublicPropertyServices;
